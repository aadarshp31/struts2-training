...
import com.zoho.struts.model.User;
import com.zoho.struts.repository.UserRepository;
...
public class UserController implements ModelDriven<Object> {
	...
	public Map<String,User[]> responseObject;
	...
	public DefaultHttpHeaders create() {
		...
		// System.out.print("VALUE STACK ADARSH: ");
		// while(stack.size() > 0){
